 ...
 */
class Correios40126 extends AbstractCorreiosModalidade {
    ...
    public function consultar($dados)
    {
        ...
        $params->setValorDeclarado(isset($dados['valor_declarado'])?$dados['valor_declarado']:null);
        ...
        $params->setCodigoServico(array('40045'));
